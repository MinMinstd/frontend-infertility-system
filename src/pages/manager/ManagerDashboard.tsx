      ...
      <Space direction="vertical" size="large" className="w-full">
          ...
          <Col xs={24} sm={12} md={6}>
            <Card className="shadow-md hover:shadow-lg transition-shadow rounded-xl">
              <Statistic
                ...
                prefix={
                  <div className="p-3 rounded-xl bg-purple-500 flex items-center justify-center">
          ...
          <Col xs={24} sm={12} md={6}>
            <Card className="shadow-md hover:shadow-lg transition-shadow rounded-xl">
              <Statistic
                ...
                prefix={
                  <div className="p-3 rounded-xl bg-green-500 flex items-center justify-center">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 mt-2">
          {managementSections.map((section, index) => (
            ...
            >
              <div className={`p-4 rounded-xl ${section.bgColor} flex items-center justify-center group-hover:scale-110 transition-transform`}>
                {section.icon}
              </div>
